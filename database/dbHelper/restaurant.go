...
func CreateRestaurant(body *models.RestaurantRequest) (string, error) {
	query := `INSERT INTO restaurant(name ,contact,opening_time,closing_time,latitude,longitude,created_by) VALUES ($1, $2, $3, $4,$5,$6,$7) RETURNING id`
	var restID string
...
func GetAllRestaurants() ([]models.RestaurantResponse, error) {
	query := `SELECT id , name  , contact , latitude , longitude , opening_time,closing_time,created_by FROM restaurant`
